...
@Configuration
@ComponentScan({"com.move.heart"})
public class AppConfiguration {

    @Bean
    public ServletContextInitializer initializer() {
        return servletContext -> {
            servletContext.setInitParameter("tapestry.app-package", "com.move.heart");
            servletContext.setInitParameter("tapestry.development-modules", "com.move.heart.services.DevelopmentModule");
